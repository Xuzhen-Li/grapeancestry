...
3. **DIY** — [README · Use it](../README.md#use-it). Stage your own VS-1 + frozen 2449×167K panel assets (FASTA/indices, sites BED, dosage, PCA·ADMIXTURE) — not in public git; see [`steps/`](../steps/).
